...
<head>
  ...
  <title>Dashboard Template · {{ config('webnav.name') }} · {{ env('APP_NAME', 'Laravel') }}</title>
  ...
  <link rel="stylesheet" href="{{ asset('./modules/' . config('webnav.name') . '/Public/default/style.css') }}">
</head>
...
<body>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="mb-0 flex justify-content-end">
                    ...
                    <a href="#" class="btn btn-sm btn-outline-primary">跳转</a>
                  </p>
                </div>
              </div>
            </div>
  ...
  <script crossorigin="anonymous" src="{{ asset('./modules/' . config('webnav.name') . '/Public/default/script.js') }}"></script>
</body>
